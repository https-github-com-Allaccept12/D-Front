...
<div className='grid grid-row-3 h-screen'>
  ...
  <div className="flex flex-row w-2/3 mx-auto">
    ...
    >
      ...
      {success === true ? <Icon name="Success" iconSize="16" className="bg-dpurple-200 rounded-full mr-3 text-white" /> : <Icon name="Cancel" iconSize="16" className="bg-dgray-400 rounded-full text-white mr-3" /> }
    ...
    <TabBtn onClick={()=> {
            ...
            className={success === true ? `text-dgray-600` : `text-dgray-400`}
            >
      {success === true ? <Icon name="Success" iconSize="16" className="bg-dpurple-200 rounded-full text-white mr-3" /> : <Icon name="Cancel" iconSize="16" className="bg-dgray-400 rounded-full text-white mr-3" /> }
            ...
            >
                    {success === true ? <Icon name="Success" iconSize="16" className="bg-dpurple-200 rounded-full text-white mr-3" /> : <Icon name="Cancel" iconSize="16" className="bg-dgray-400 rounded-full text-white mr-3" /> }
              {array_sample[3].tab}</TabBtn>

<TabBtn success={success} onClick={()=> {
              changeItem([4])
            }}
            className={success === true ? `text-dgray-600` : `text-dgray-400`}
            >
                    {success === true ? <Icon name="Success" iconSize="16" className="bg-dpurple-200 rounded-full text-white mr-3" /> : <Icon name="Cancel" iconSize="16" className="bg-dgray-400 rounded-full text-white mr-3" /> }
              {array_sample[4].tab}</TabBtn>
