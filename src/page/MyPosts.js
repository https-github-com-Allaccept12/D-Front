        ...
        <>
            ...
            <div className="flex">
                <div className="flex flex-row justify-center items-center w-full">
                    ...
                    <SnsIcons sns="Kakao" />
                    <SnsIcons sns="Linkedin" />
                    <SnsIcons sns="Twitter" />
                    <SnsIcons sns="Url" />
                </div>
            </div>
            ...
            <div className="flex flex-row w-3/4 flex-wrap gap-3">
                ...
                <Button size="1" color="4">
                    버튼버튼
                </Button>
                <Button size="2" color="5">
                    버튼버튼
                </Button>
                ...
                <Button size="1" color="1" icon name="Private" iconSize="16" iconColor="">
                    버튼버튼
                </Button>
                <Button size="2" color="4" icon name="Private" iconSize="16" iconColor="">
                    버튼버튼
                </Button>

                <Button size="2" color="6" icon name="HeartF" iconSize="16" iconColor="heart">
                    버튼버튼
                </Button>
            </div>
            ...
            <div className="flex flex-row flex-wrap w-5/6">
                <Card size="1" types="text">
                    <span className="font-min1 text-5xl ">1</span>
                </Card>
                <Card size="2" types="text">
                    <span className="font-min1 text-5xl ">2</span>
                </Card>
                <Card size="3" types="text">
                    <span className="font-min1 text-5xl ">3</span>
                </Card>
                <Card size="4" types="text">
                    <span className="font-min1 text-5xl ">4</span>
                </Card>
                <Card size="5" types="text">
                    <span className="font-min1 text-5xl ">5</span>
                </Card>
                <Card size="6" types="text">
                    <span className="font-min1 text-5xl ">6</span>
                </Card>

                <Card
                    size="1"
                    types="image"
                    src="https://press.ikidane-nippon.com/wordpress/wp-content/uploads/2019/03/key-1-1.jpg"
                />
                <Card
                    size="2"
                    types="image"
