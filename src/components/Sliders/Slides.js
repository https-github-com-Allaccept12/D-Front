...
<div className="flex flex-row items-center justify-center mt-5 shrink-0 gap-x-3">
          <div className=" w-[8.375rem]
           h-[15rem] rounded-lg">
             <Thumbnail src={props.Thumbnail} className="object-cover object-center overflow-hidden" />
           </div>
                 <div className="bg-yellow-200 w-[8.375rem]
           h-[15rem] rounded-lg">
             <Thumbnail src={props.Thumbnai2} className="object-cover object-center overflow-hidden" />
           </div>
           </div>
        </div>
          </div>
        ...
        rounded-b-xl w-[18.75rem] h-[8.75rem]">
            ...
            {!props.follow ? <Button size="3" color="1">팔로우</Button> : <Button size="3" color="4">팔로잉</Button>}
            </div>
        </div>
    </div>
    </>
