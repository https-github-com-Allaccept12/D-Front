...
const DimoCreate = () => {
        ...
        <Subtitle size="1">디자이너님들에게 질문해보세요! 멋진 정보를 얻을 수 있을거에요!</Subtitle>
               ...
               <div className="w-full ">
                ...
                <div className="bg-white p-10 border border-dpurple-200 border-dashed w-4/5 mx-auto max-w-[56.25rem] ">
                  <div className="flex justify-center items-center flex-col"><Button size="2">추가하기</Button>
                  <Text size="3" className="pt-10 pb-7">파일추가 파일은 복수로 첨부가능하며 최대 100mb까지 업로드됩니다.</Text>
                  </div>
  ...
  if(status === "shared") return (
    ...
    <div className="bg-gray-100 h-screen">
        ...
        <Subtitle size="1">알고 계신 정보를 공유해주세요! 다른 디자이너분들께 큰 도움이 될 거에요!</Subtitle>
                 <div className="bg-white">
               <div className="w-full ">
                크리에이트 디모 QnA
                <div className="flex flex-row w-4/5 max-w-[56.25rem] mx-auto gap-5">
