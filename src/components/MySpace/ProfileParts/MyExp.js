...
<div className="gap-14 flex flex-row my-7">
        ...
        <Title size="6">EXPERIENCE</Title> <Title size="6" className="text-gray-300 font-extralight">총 1년</Title></div>
        <Line /> 
        ...
        <Text size="3" className="mt-1 leading-none text-gray-400">2022~03 재직중</Text>
        
    </li>
    <ul className="mb-10 ml-4 row-start-1 col-start-2 col-span-full list-disc">

    <Title size="6">Product Designer / Design</Title>
        <La> UX 설계, UX 디자인, Prototype을 통해 유저에게 가치를 전달하는 모든 설계 과정에 관여하며, 고객이 바라보는 제품의 경험을 결정
        </La>
        <La> 고객이 제품을 사용하면서 느끼는 불편한 점과 의견들을 정성, 정량적으로 수집하여 고객의 니즈를 충족하는 제품이 될 때까지 개선을 반복
        </La>
        <La> 비즈니스가 함께 성장할 수 있는지 고민하며, 팀의 비즈니스 성공 위해 헌신
        </La>
