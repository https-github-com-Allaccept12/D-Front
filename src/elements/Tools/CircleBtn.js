...
const Icons = tw.i`
rounded-full bg-white w-16 h-16 justify-center flex flex-row items-center
...
const CircleBtn = (props) => {
  const { name, iconSize, onClick } = props;
    ...
    if (name === "Edit") {
        ...
        <Text size="1" className="text-white mt-2">수정</Text>
        </IconBox>
        </>
        );
      }
    ...
    if (name === "Delete") {
        ...
        <Text size="1" className="text-white mt-2">삭제</Text>
        </IconBox>
        </>
        );
        }
    ...
    if (name === "MyStar") {
        ...
        <Text size="1" className="text-white mt-2">대표작품</Text>
        </IconBox>
        </>
        );
        }
    ...
    if (name === "Private") {
        ...
        <Text size="1" className="text-white mt-2">비공개</Text>
        </IconBox>
        </>
        );
        }
